...
export const ChatroomHeader: FC<Props> = (props) => {
  return (
    <header className={"bg-back-light-0"}>
      <div className={"flex  align-middle gap-2 p-3"}>
        ...
        <ToggleButton toggled={props.orderFlow === "desc"}
                      onClick={() => props.onFlowChange("desc")}>Desc</ToggleButton>
      </div>
    </header>
  )
}